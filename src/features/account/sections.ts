 ...
 * misma navegacion sirve montada en `/account` y en la vista previa de
 * desarrollo (`/__dev/account`) sin depender del prefijo. `.` es la seccion
 * indice ("Perfil"); el resto coincide con el segmento de su ruta hija en
 * `routes.tsx`.
 */
