...
| Suite                                       | Qué demuestra                                                                                                                                                                                              |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DifficultySelector.test.tsx`               | Grupo accesible, motivo del bloqueo como descripción, teclado, un nivel bloqueado que no se elige ni con ratón ni con teclado, y que el selector obedece al servicio aunque sus datos contradigan la regla |
